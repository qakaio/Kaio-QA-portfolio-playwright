...
- **Allure Report** — Advanced test reporting with trends, history, and categorization
...
├── package.json
├── .github/workflows/
│   └── playwright.yml            # CI/CD pipeline (3 browsers + Cloudflare skip + Allure)
└── README.md
```
...
**Live Allure Report**: [https://qakaio.github.io/Kaio-QA-portfolio-playwright/allure-report/](https://qakaio.github.io/Kaio-QA-portfolio-playwright/allure-report/)

### Features
- **Test Trends** — Pass/fail history over time
- **Categories** — Tests grouped by severity, type, browser
...
### CI/CD Simulation
```bash
# Run exactly as CI does (with retries, trace on failure, Allure)
npx playwright test --retries=2 --trace=on-first-retry --reporter=line,allure-playwright
```
...
- **Live Report**: [https://qakaio.github.io/Kaio-QA-portfolio-playwright/allure-report/](https://qakaio.github.io/Kaio-QA-portfolio-playwright/allure-report/)
- **Features**: Trends, categories, history, retry timeline, duration analysis

### CI/CD Pipeline (GitHub Actions)
- **Schedule**: Daily at 09:00 & 21:00 UTC
- **Triggers**: Push to main, PR, Schedule
- **Stages**: Install → Lint → Test (Chromium/Firefox/WebKit) → Allure → Deploy Pages
- **Artifacts**: HTML report (merged 3 browsers), Allure report, traces, screenshots on failure
