...
- insertion:
  - text: Discover more
  - link "Polo Brand Clothes":
    - img
    - text: Polo Brand Clothes
  - link "Printed Off Shoulder Tops":
    - img
    - text: Printed Off Shoulder Tops
  - link "Shirt":
    - img
    - text: Shirt
  - link "Winter Tops":
  ...
  - link "Mast & Harbour":
    - img
    - text: Mast & Harbour
  - link "Colour Blocked Shirt":
    - img
    - text: Colour Blocked Shirt
  - link "Full Sleeves Tops":
    - img
    - text: Full Sleeves Tops
...
- insertion:
  - iframe
- img
- link "Go to shopping options for Dress": Dress
